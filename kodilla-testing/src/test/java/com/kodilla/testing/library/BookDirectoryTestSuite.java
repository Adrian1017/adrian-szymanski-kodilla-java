...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOfBooks0() {
        ...
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        List<Book> resultListOf0Books = new ArrayList<>();
        LibraryUser libraryUser = new LibraryUser("John","Smtih","1234567890");
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(resultListOf0Books);
        // When
        List<Book> actualListOfBorrowedBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        // Then
        assertEquals(0, actualListOfBorrowedBooks.size());
    }
    ...
    public void testListBooksInHandsOfBooks1() {
        ...
        libraryUser.addBook(new Book("Title", "Author",1999));
        // When
        List<Book> actualListOfBorrowedBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        // Then
        assertEquals(1, actualListOfBorrowedBooks.size());
    }
    ...
    public void testListBooksInHandsOfBooks5() {
        ...
        for( int i = 0; i < 5; i++){
            libraryUser.addBook(new Book("Title " + i,"Author " + i, 1999 + i));
        }
        // When
        List<Book> actualListOfBorrowedBooks = bookLibrary.listBooksInHandsOf(libraryUser);
        // Then
        assertEquals(5, actualListOfBorrowedBooks.size());
    }
